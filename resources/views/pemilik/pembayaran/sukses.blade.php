...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('pemilik.pembayaran.sukses') }}" method="GET" class="row g-3 align-items-end">
                    <div class="col-md-2">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex gap-2 flex-wrap flex-md-nowrap">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-filter me-1"></i>
                                Filter</button>
                            <a href="{{ route('pemilik.pembayaran.sukses') }}" class="btn btn-outline-secondary"><i
        ...
        <div class="card shadow">
            <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
                <h5 class="m-0 font-weight-bold">Daftar Pembayaran</h5>
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('pemilik.pembayaran.export.excel', request()->all()) }}" class="btn btn-success">
                        <i class="fas fa-file-excel me-1"></i> Export Excel
                    </a>
                    <a href="{{ route('pemilik.pembayaran.export.pdf', request()->all()) }}" class="btn btn-danger">
                        ...
                        <tbody>
                            @forelse ($pembayaran as $payment)
                                <tr>
                                    ...
                                    <td>
                                        @if ($payment->booking)
                                            <a href="{{ route('pemilik.pembayaran.show', $payment->id) }}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            @if ($payment->status_pembayaran == 'processing')
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="alert alert-info">
                                                            <i class="fas fa-info-circle me-2"></i> Pembayaran akan diubah
                                                            statusnya menjadi "Sukses" dan booking akan dikonfirmasi.
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('pemilik.pembayaran.approve', $payment->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="alert alert-warning">
                                                            <i class="fas fa-exclamation-triangle me-2"></i> Pembayaran
                                                            akan diubah statusnya menjadi "Gagal".
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Batal</button>
                                                        <form
                                                            action="{{ route('pemilik.pembayaran.reject', $payment->id) }}"
                                                            method="POST">
                                                            @csrf
