                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pembayaran->currentPage() }} / {{ $pembayaran->lastPage() }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 text-white"><i class="fas fa-clock me-2"></i>Daftar Pembayaran Kadaluarsa</h5>
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('pemilik.pembayaran.export.excel', array_merge(request()->all(), ['status' => 'expired'])) }}"
                            class="btn btn-light btn-sm">
                            <i class="fas fa-file-excel me-1 text-success"></i> Export Excel
                        </a>
                        <a href="{{ route('pemilik.pembayaran.export.pdf', array_merge(request()->all(), ['status' => 'expired'])) }}" class="btn btn-light btn-sm">
