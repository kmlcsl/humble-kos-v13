...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.pengaturan.admins') }}">Pengguna Admin</a></li>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h6 class="m-0 font-weight-bold">Formulir Edit Admin</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.pengaturan.admins.update', $admin->user_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.pengaturan.admins') }}" class="btn btn-secondary me-2">Batal</a>
