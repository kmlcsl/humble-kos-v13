        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-danger text-white">
                    <h5 class="card-title mb-0 text-white"><i class="fas fa-times-circle me-2"></i>Booking Dibatalkan</h5>
                </div>
                <div class="card-body py-0">
                    ...
                    @else
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>Tidak ada booking yang dibatalkan.
                        </div>
                    @endif
                </div>
            </div>
