            ...
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('pemilik.pembayaran.export.excel', array_merge(request()->all(), ['status' => 'pending'])) }}"
                            class="btn btn-light btn-sm">
                            <i class="fas fa-file-excel me-1 text-success"></i> Export Excel
                        </a>
                        <a href="{{ route('pemilik.pembayaran.export.pdf', array_merge(request()->all(), ['status' => 'pending'])) }}" class="btn btn-light btn-sm">
                            ...
                            <table class="table table-hover table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pemilik.pembayaran.show', $item->pembayaran_id) }}"
                                               class="btn btn-sm btn-outline-info" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <form action="{{ route('pemilik.pembayaran.approve', $item->pembayaran_id) }}"
                                            ...
                                            <form action="{{ route('pemilik.pembayaran.reject', $item->pembayaran_id) }}"
                                                  method="POST" class="d-inline">
                                                @csrf
