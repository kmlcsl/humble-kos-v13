            ...
            <div class="col-auto d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                        <li>
                            <h6 class="dropdown-header">Halo, {{ Auth::user()->name ?? 'Admin' }}!</h6>
                        </li>
                        <li><a class="dropdown-item" href="#"><i class="fas fa-user me-2 text-primary"></i> Profile
                                Saya</a></li>
                        <li><a class="dropdown-item" href="#"><i class="fas fa-cog me-2 text-primary"></i>
                                Pengaturan</a></li>
                        <li>
                        ...
                        <li>
                            ...
                            <form id="header-logout-form" action="#" method="POST" class="d-none">
                                @csrf
                            </form>
                        </li>
                    </ul>
