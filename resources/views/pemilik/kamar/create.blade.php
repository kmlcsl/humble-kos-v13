...
@section('content')
    <form action="{{ route('pemilik.kamar.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="admin-pemilik-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="foto_kamar" class="form-label">Foto Utama</label>
                            <input type="file" class="form-control @error('foto_kamar') is-invalid @enderror"
                                   id="foto_kamar" name="foto_kamar" accept="image/*" onchange="previewMainImage(this)">
                            @error('foto_kamar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            @error('foto_tambahan.*')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Total maksimal 4 foto (1 utama + 3 tambahan)</div>
        ...
        function previewAdditionalImages(input) {
            ...
            if (input.files) {
                ...
                if (input.files.length > 3) {
                    alert('Maksimal 3 foto tambahan. Hanya 3 foto pertama yang akan digunakan.');
                }
            }
        }
