...
<div class="btn-group" role="group">
    <a href="{{ route('pemilik.kamar.update', $kamars->kamar_id) }}" class="btn btn-primary">
                    ...
                    <dd class="col-sm-8">
                        ...
                        @if($kosanRel)
                            ...
                            @if($kosanId && $kosanNama)
                                <a href="{{ route('pemilik.kosan.show', $kosanId) }}" class="text-white">
                                    {{ $kosanNama }}
                                </a>
                            @elseif($kosanNama)
                                <span>{{ $kosanNama }}</span>
    ...
    <div class="col-xl-4">
        ...
        <div class="admin-pemilik-card border-left-secondary mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('pemilik.kamar.change-status', $kamars->kamar_id) }}" method="POST">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="admin-pemilik-card border-left-danger mb-4">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-12">
                        <a href="{{ route('pemilik.kamar.update', $kamars->kamar_id) }}" class="btn btn-primary w-100">
            ...
            <div class="card-body">
                <div class="kosan-card">
                    @php
                        $kosanRel = $kamars->kosan ?? $kamars->kosanById;
                    @endphp
                    @if($kosanRel && $kosanRel->fotoUtama)
                        <img src="{{ asset('storage/' . $kosanRel->fotoUtama->path_gambar) }}" alt="{{ ($kosanRel->nama_kosan ?? $kosanRel->nama_kos) }}" class="img-fluid rounded mb-3">
                    @endif
                    ...
                    @endphp
                    @if($kosanId)
                    <a href="{{ route('pemilik.kosan.show', $kosanId) }}" class="btn btn-outline-primary w-100">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('pemilik.kamar.delete', $kamars->kamar_id) }}" method="POST">
                    @csrf
                    @method('DELETE')
